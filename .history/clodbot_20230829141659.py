...
async def fetch_smogon_set(pokemon_name: str) -> str:
    ...
    # Let's print the beginning of the page content to ensure we're seeing what we expect
    page_content_start = driver.page_source[:1000]  # First 1000 characters
    print(f"Beginning of page content:\n{page_content_start}\n...")
