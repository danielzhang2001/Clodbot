...
class GiveSet:
    ...
    async def set_selection(
        ...
        if deselected:
            ...
            GiveSet.selected_sets.setdefault(key, {})[pokemon_state].append(set_data)
        set_data = "\n\n".join(
            "\n\n".join(data for data in pokemon_sets)
            for pokemon_sets in GiveSet.selected_sets.get(key, {}).values()
        )
