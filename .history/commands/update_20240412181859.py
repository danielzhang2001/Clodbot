        ...
        try:
            ...
            for player_data in formatted_stats:
                ...
                if check_labels(values, name):
                    stats_range = f"Stats!{get_range(values, name)}"
                    update_data(
                        service, spreadsheet_id, sheet_id, stats_range, pokemon_data
                    )
                else:
                    ...
                    bold_cells(service, spreadsheet_id, sheet_id, stats_range)
