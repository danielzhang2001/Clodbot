            ...
            if faint:
                ...
                for revive in revives:
                    if revive:
                        ...
                        if revive_match:
                            player = revive_match.group(1)
                            revived_pokemon = revive_match.group(3)
                            revived_key = f"{player}: {nickname_mapping_player1.get(revived_pokemon.strip(), revived_pokemon.strip())}" if player == 'p1' else f"{player}: {nickname_mapping_player2.get(revived_pokemon.strip(), revived_pokemon.strip())}"
