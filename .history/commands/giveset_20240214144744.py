...
class GiveSet:
    ...
    async def set_selection(interaction, unique_id, set_index, set_name, url, pokemon):
        ...
        async with lock:
            ...
            try:
                # Assuming fetch_set and get_textarea functions are defined elsewhere and work synchronously
                # You might need to adjust this part to actually fetch the set data
                set_data = "...fetch set data here..."
