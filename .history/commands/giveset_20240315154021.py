...
class GiveSet:
    ...
    @staticmethod
    def fetch_set(pokemon: str, generation: str, format: str, set_name: str) -> str:
    ...
    @staticmethod
    async def set_selection(interaction, pokemon: str, generation: Optional[str] = None, format: Optional[str] = None, set_name: str):
