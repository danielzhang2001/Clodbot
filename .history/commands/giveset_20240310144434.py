...
class GiveSet:
    ...
    def fetch_all_pokemon() -> List[str]:
        ...
        if last_modified:
            ...
            last_modified_cache = None
            last_modified_server_date = last_modified_server.date()
        testing = GiveSet.pokemon_cache["last_modified"]
        print(f"NEW FOUND LAST MODIFIED: {last_modified}")
        print(f"OLD FOUND LAST MODIFIED: {testing}")
