...
class Update:
    ...
    async def update_sheet(
        ...
        try:
            ...
            stats = get_stats(raw_data, pokes, p1_count, nickname_mapping1, nickname_mapping2)
            ...
            if sheet_id is None:
                ...
                sheet_response = (service.spreadsheets().batchUpdate(spreadsheetId=spreadsheet_id, body=body).execute())
            ...
            for player_data in formatted_stats:
                ...
                if check_labels(values, name):
                    ...
                    add_data(service, spreadsheet_id, sheet_id, start_cell, name, pokemon_data)
            return f"Sheet updated here: **{sheet_link}**."
        except requests.exceptions.RequestException:
        return f"**{replay_link}** is an invalid replay link."
    except googleapiclient.errors.HttpError:
        return f"**{sheet_link}** is an invalid Google Sheets link."
