    ...
    async def fetch_set(pokemon: str, generation: str, format: str, set: str) -> str:
        ...
        try:
            ...
            if generation is None and format is None and set is None:
                # You can add logic here to check for the most recent generation and first format
                # For now, let's check if the Pokémon exists at all
                driver.get(f"https://www.smogon.com/dex/")
