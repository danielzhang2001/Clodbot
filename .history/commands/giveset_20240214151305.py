                ...
                if get_export_btn(driver, set_name):
                    ...
                    if set_data:
                        ...
                        if "combined_message_id" in context:
                            ...
                            # Update the message content and disable the clicked button
                            for component in message.components:
                                for item in component.children:
                                    if (
                                        ...
                                        item.disabled = True
                            await message.edit(
                                content=message_content, components=message.components
                            )
                        else:
                            # If no combined_message_id, send a new message (this scenario might need adjustment based on actual use case)
