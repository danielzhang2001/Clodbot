...
def update_buttons(view, selected_button_custom_id):
    # Iterate through all items in the view (buttons in this case)
    for item in view.children:
        # If the item's custom_id matches the selected button, set it to green
        if item.custom_id == selected_button_custom_id:
            item.style = ButtonStyle.success
        # Otherwise, keep or set it to gray
        else:
