...
async def analyze_replay(ctx, *args):
    ...
    for nickname, pokemon in nickname_mapping.items():
        print(f"Nickname: {nickname}, Pokemon: {pokemon}")
    ...
    for faint in faints:
        if faint:
            ...
            print(f"{fainted_pokemon[1]}")
            print(
                f"{nickname_mapping.get(fainted_pokemon[1], fainted_pokemon[1])}")
