...
def widen_cells(service: Resource, spreadsheet_id: str, sheet_id: int) -> None:
    ...
    columns = [
        ...
        {"startColumnIndex": 16, "endColumnIndex": 20},
    ]
    requests = [
        {
            "updateDimensionProperties": {
                "range": {"sheetId": sheet_id, "dimension": "COLUMNS", **column},
