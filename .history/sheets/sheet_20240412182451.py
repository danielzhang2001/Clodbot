        ...
        "requests": [
            {
                "repeatCell": {
                    "range": {
                        "sheetId": sheet_id,
                        "startRowIndex": start_row - 1,  # Convert to zero-indexed
                        "endRowIndex": end_row,  # Exclusive, hence no need for -1
                        "startColumnIndex": ord(start_col)
                        - ord("A"),  # Convert to zero-indexed
                        "endColumnIndex": ord(end_col)
                        - ord("A")
                        + 1,  # Convert to zero-indexed, inclusive
                    },
