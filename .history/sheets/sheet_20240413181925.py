...
def get_bandings(
    ...
    for banded_range in banded_ranges:
        if banded_range["range"]["sheetId"] == sheet_id:
            b_start_row = banded_range["range"]["startRowIndex"]
            b_end_row = banded_range["range"]["endRowIndex"]
            b_start_col = banded_range["range"]["startColumnIndex"]
            b_end_col = banded_range["range"]["endColumnIndex"]
            if not (
                b_end_row <= start_row
                or b_start_row >= end_row
                or b_end_col <= start_col
                or b_start_col >= end_col
            ):
