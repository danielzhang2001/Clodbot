...
def clear_cells(service: Resource, spreadsheet_id: str, sheet_id: int, cell_range: str):
        ...
        "requests": [
            {
                "repeatCell": {
                    ...
                    "cell": {
                        "userEnteredFormat": {
                            "backgroundColor": {"red": 1, "green": 1, "blue": 1},  # Reset to white (transparent by default)
                            "textFormat": {
                                "foregroundColor": None,  # Reset text color to default
                            ...
                            "horizontalAlignment": "LEFT",  # Reset horizontal alignment
                            "verticalAlignment": "BOTTOM",  # Reset vertical alignment
                            "wrapStrategy": "OVERFLOW_CELL",  # Reset wrap strategy
                            "borders": None  # Clear all borders
                        }
                    },
    ...
    # Execute the batchUpdate to clear all formats
    service.spreadsheets().batchUpdate(spreadsheetId=spreadsheet_id, body=body).execute()
    print("All cell formatting should now be cleared.")
