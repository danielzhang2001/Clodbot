                ...
                if value.strip() and not (
                    ...
                    for k in range(j - 1, 0, -1):
                        ...
                        if idx < len(values[k]) and "POKEMON" in values[k][idx]:
                            ...
                            continue
                    if player:
                        kills = row[idx + 2].strip() if idx + 2 < len(row) and row[idx + 2].strip().isdigit() else "N/A"
    deaths = row[idx + 3].strip() if idx + 3 < len(row) and row[idx + 3].strip().isdigit() else "N/A"
