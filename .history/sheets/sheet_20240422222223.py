...
def widen_columns(service: Resource, spreadsheet_id: str, sheet_id: int) -> None:
    ...
    columns = [
        {"dimensionRange": {"sheetId": sheet_id, "dimension": "COLUMNS", "startIndex": 1, "endIndex": 5}},
        {"dimensionRange": {"sheetId": sheet_id, "dimension": "COLUMNS", "startIndex": 6, "endIndex": 10}},
        {"dimensionRange": {"sheetId": sheet_id, "dimension": "COLUMNS", "startIndex": 11, "endIndex": 15}},
        {"dimensionRange": {"sheetId": sheet_id, "dimension": "COLUMNS", "startIndex": 16, "endIndex": 20}},
    ]
    requests = [
        {
