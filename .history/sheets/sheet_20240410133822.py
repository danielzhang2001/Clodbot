...
def check_labels(values, player_name):
    # Convert the list of lists into a dictionary to find the index of the player_name
        ...
        if player_name in row:
            try:
                ...
                if (
                    ...
                    if (
                        values[row_index + 1][name_index + 1] == "Kills"
