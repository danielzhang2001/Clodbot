...
class InvalidCommand(Exception):
    ...
    def __init__(self):
        super().__init__(
            ...
            "Clodbot, display (Google Sheets Link) ['Players' OR 'Pokemon]\n"
...
class NoDisplay(Exception):
    # Exception raised when no argument for display is found.
    def __init__(self):
        super().__init__(
            "Please follow this format:\n"
            "```\n"
            "Clodbot, display (Google Sheets Link) ['Player' OR 'Pokemon']\n"
            "```"
        )
