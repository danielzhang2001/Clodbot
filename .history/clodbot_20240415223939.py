...
from commands.delete import Remove
from errors import *
...
async def update_sheet(ctx: commands.Context, *args: str):
    ...
    if command == "update":
        update_message = await Update.update_sheet(creds, sheets_link, content)
    elif command == "delete":
        update_message = await Delete.delete_player(creds, sheets_link, content)
