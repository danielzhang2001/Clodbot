...
async def on_command_error(ctx: commands.Context, error: commands.CommandError) -> None:
    ...
    elif isinstance(error, InvalidReplay):
        await ctx.send(f"**{error.link}** is an invalid replay link.")
    elif isinstance(error, InvalidSheetsLink):
        await ctx.send(f"**{error.link}** is an invalid Google Sheets link.")
